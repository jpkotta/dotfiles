(custom-set-variables
 ...
 '(truncate-lines t))
(custom-set-faces
 '(default ((t (:size "11pt" :family "Dejavu Sans Mono" :stipple nil :background "gray12" :foreground "green" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal))) t)
