...
# add nodelay to pam_faillock.so and pam_unix.so lines
# add pam_faildelay.so to set a different delay (microsec)
...
* dtach
* dunst
ln -s /usr/share/dbus-1/services/org.knopwob.dunst.service ~/.local/share/dbus-1/services/org.knopwob.dunst.service
** libnotify
* emacs-lucid
* etc-update
* figlet
...
netExtender -u jonathan.kotta -d packetdigital.com vpn.packetdigital.com:4433
* nfs-utils
** client
